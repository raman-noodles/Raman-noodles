...
def test_peak_position_comparisons():
    ...
    assert type(peakidentify.peak_position_comparisons(unknown_peaks, known_peaks, known_compound_list,
...
def test_percentage_of_peaks_found():
    ...
    try:
        ...
        print("""The function correctly handled the case where the compound list contains something
